...
def load_known_faces():
    ...
    try:
        with open(DEFAULT_ENCODINGS_PATH, "rb") as face_data_file:
            # known_face_encodings, known_face_metadata = pickle.load(face_data_file)
            loaded_encodings = pickle.load(face_data_file)
            known_face_encodings, known_face_metadata = loaded_encodings["encodings"], loaded_encodings["names"]
            ...
            #     pprint.pprint(loaded_encodings, stream=file)
...
#     #         )
#     return "v4l2src device=/dev/video0 ! video/x-raw,format=YUY2,width=1280, height=720, framerate=30/1 ! videoconvert ! video/x-raw, format=(string)BGR ! appsink"
...
def main_loop():
    ...
    while True:
        ...
        #reset face_locations and face_encodings
        face_locations = []
        face_encodings = []
        ...
        for face_location, face_encoding in zip(face_locations, face_encodings):
            ...
            if metadata is not None:
                ...
                face_label = metadata["names"]

            # If this is a brand new face, add it to our list of known faces
            else:
                face_label = "Unknown visitor!"
